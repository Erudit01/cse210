...
class Program
{
    ...
    {
        // Notice that the list is a list of "Shape" objects. That means you can put any Shape objects in there, and also, any object where the class inherits from Shape
